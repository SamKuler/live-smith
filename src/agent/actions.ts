...
export function actionSystemPrompt(): string {
  return [
    ...
    "When a validated Session MIDI artifact is available, create_midi_clip_from_artifact may appear in the apply_live_actions schema. Use its exact artifactRef to create one Arrangement MIDI Clip; Live Smith reads and validates the saved file, supplies its duration and notes, and still applies ordinary Scope, confirmation, preflight, serialization, and drift checks.",
